...
<html lang="es">
	<head>
		...
		<link rel="shortcut icon" href="imgs/logo_fav.png">
	...
	<body>
		...
		<nav class="ink-container ink-navigation">
			<ul class="horizontal menu">
				...
				<li>
					<a href="centros.php">Gestión Centros</a>
				</li>
				<li>
					<a href="ensenanzas.php">Gestión Enseñanzas</a>
				</li>
				<li>
					<a href="profesores.php">Gestión Profesores</a>
				</li>
				<li>
					<a href="textos.php">Gestión Muestras</a>
				</li>
				<li>
					<a href="visitas.php">Gestión Visitas</a>
				</li>
			</ul>
		</nav>
